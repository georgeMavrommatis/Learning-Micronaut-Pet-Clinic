...
/**
 * Represents a review of a veterinarian submitted by a user.
 *
 * <p>Mapped to the <code>vetReviews</code> table in the database, this entity captures the
 * reviewer’s name, review content, rating, and creation date.
 *
 * @author Your Name
 */
@Introspected
...
public class VetReview {
   ...
   *
   * <p>References the primary key of the {@link Vet Vet} entity.
   */
  private Long vetId;
